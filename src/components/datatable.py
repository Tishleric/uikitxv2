...
class DataTable(BaseComponent):
    ...
    def __init__(self, id, data=None, columns=None, theme=None, style_table=None, style_cell=None, style_header=None, style_data_conditional=None, page_size=10, className=""):
        ...
        Args:
            ...
            data (list or DataFrame, optional): Data to display in the table. Defaults to None.
            columns (list, optional): Column definitions. Defaults to None.
            theme (Any, optional): Theme object for styling. Defaults to None.
            style_table (dict, optional): Additional styles for the table container. Defaults to None.
            style_cell (dict, optional): Additional styles for table cells. Defaults to None.
            style_header (dict, optional): Additional styles for table headers. Defaults to None.
        ...
        Note:
            className is accepted here but NOT passed to dash_table.DataTable.
        """
    ...
    def render(self):
        ...
        Returns:
            dash_table.DataTable: A Dash table component with applied theming.
        """
